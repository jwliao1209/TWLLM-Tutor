...
class Prompt:
    def __init__(self, with_incontext: bool = False) -> None:
...
class Answer:
    ...
    def get(self, data: dict) -> str:
        ...
        if self.with_answer_details:
            return f"{data['answer_details']}所以答案為{data['answer']}.{data[str(data['answer'])]}"
        else:
            # Example: "A. XXXX"
